<?php 
   ...
   else
   {
     ...
     $sql="create table pubgm_matches(id int(2) PRIMARY KEY  auto_increment,name char(20),date varchar(10),time varchar(10),map char(20),type char(10),view char(5),entry_fee int(10),room_id varchar(30),room_pass varchar(10))";
